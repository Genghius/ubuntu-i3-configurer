...
rofi -v 2> /dev/null 1> /dev/null || (echo "rofi $yikes" && apt install -y rofi 1> /dev/null 2> /dev/null )
awk -V 2> /dev/null 1> /dev/null || (echo "awk $yikes" && apt install -y mawk 1> /dev/null 2> /dev/null )
feh -v 2> /dev/null 1> /dev/null || (echo "feh $yikes" && apt install -y feh 1> /dev/null 2> /dev/null )
sensors -v 2> /dev/null 1> /dev/null || (echo "sensors $yikes" && apt install -y lm-sensors 1> /dev/null 2> /dev/null )
mpstat -V 2> /dev/null 1> /dev/null || (echo "mpstat $yikes" && apt install -y sysstat 1> /dev/null 2> /dev/null )
scrot -v 2> /dev/null 1> /dev/null || (echo "scrot $yikes" && apt install -y scrot 1> /dev/null 2> /dev/null )
dmenu -v 2> /dev/null 1> /dev/null || (echo "dmenu $yikes" && apt install -y dmenu 1> /dev/null 2> /dev/null )
i3blocks -V 2> /dev/null 1> /dev/null || (echo "i3blocks $yikes" && apt install -y i3blocks 1> /dev/null 2> /dev/null )
pulseaudio --version 2> /dev/null 1> /dev/null || (echo "pulseaudio $yikes" && apt install -y pulseaudio 1> /dev/null 2> /dev/null )
dunst -v 2> /dev/null 1> /dev/null || (echo "dunst $yikes" && apt install -y dunst 1> /dev/null 2> /dev/null )

# At this point why havent i called it debian i3 configurer? lolkek
ps -e | grep X 2> /dev/null 1> /dev/null || X -v 2> /dev/null 1> /dev/null || (echo "Xorg $yikes" && apt install -y xorg 1> /dev/null 2> /dev/null && echo "exec i3" >> /home/$user/.xinitrc)

# More checking
echo "checking i3 or i3-gaps is installed..."
i3 -v 2> /dev/null 1> /dev/null || (echo "i3-gaps $yikes" && apt install -y libxcb1-dev libxcb-keysyms1-dev libpango1.0-dev libxcb-util0-dev libxcb-icccm4-dev libyajl-dev libstartup-notification0-dev libxcb-randr0-dev libev-dev libxcb-cursor-dev libxcb-xinerama0-dev libxcb-xkb-dev libxkbcommon-dev libxkbcommon-x11-dev autoconf xutils-dev libtool automake libxcb-xrm-dev 1> /dev/null && git clone https://www.github.com/Airblader/i3 i3-gaps && cd i3-gaps && git checkout gaps && git pull && autoreconf --force --install && rm -rf build && mkdir build && cd build && ../configure --prefix=/usr --sysconfdir=/etc --disable-sanitizers && make && sudo make install && cd ..)
